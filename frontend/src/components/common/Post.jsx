...
const Post = ({ post }) => {
	...
	const {mutate: likePost, isPending: isLiking} = useMutation({
		...
		onSuccess: (data) => {
			...
			// queryClient.invalidateQueries({queryKey: ["posts"]});  //Not great user experience as refetching whole posts 
			// Better approach => Update the cache directly
					...
					<div className='flex gap-2 items-center'>
						...
						{isMyPost && (
							<span className='flex justify-end flex-1'>
								{!isDeleting&& <FaTrash className='cursor-pointer hover:text-red-500' onClick={ e => handleDeletePost(e)} />}
